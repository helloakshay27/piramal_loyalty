  ...
  const fetchSegments = async () => { 
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}loyalty/segments.json?access_token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414&q[loyalty_type_id_eq]=${storedValue}`
        // `https://staging.lockated.com/loyalty/segments.json?access_token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414&page=${page}&per_page=${itemsPerPage}&&q[loyalty_type_id_eq]=${storedValue}`
      );
